...
def main():
    ...
    # test_app_flows("edgedetect", True, False, useHls=True)
    ...
    ### Rosetta
    test_bench_flows("Rosetta-3d-rendering-N", True, False, useHls=False)
    test_bench_flows("Rosetta-digit-recognition-N", True, False, useHls=False)
    test_bench_flows("Rosetta-face-detection-N", True, False, useHls=False)
    test_bench_flows("Rosetta-optical-flow-current", True, False, useHls=False)
    test_bench_flows("Rosetta-spam-filter-N", True, False, useHls=False)
